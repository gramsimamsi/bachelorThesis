...
\item Regarding the design and implementation of applications running on the solutions, it is assumed that conventional application security measures have been implemented, i.e. against the OWASP Top 10 (SOURCE: LINK IN COMMENTS %https://www.owasp.org/index.php/Category:OWASP_Top_Ten_Project).\\
...
(TODO: you manage <-> other manages LINK IN COMMENTS %https://www.bmc.com/blogs/saas-vs-paas-vs-iaas-whats-the-difference-and-how-to-choose/ )

\cite{servicecomparison}
...
(TODO Quelle: LINK COMMENTED % https://docs.microsoft.com/en-us/azure/aks/operator-best-practices-cluster-security?view=azuremgmtbilling-1.1.0-preview\#process-node-updates-and-reboots-using-kured )
