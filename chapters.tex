...
In addition to these assumptions, two specific implementations were selected and a software version was chosen. Additional solutions or software versions have not been assessed due to the exponential increase in workload to do so, but the process outlined in this thesis could be used to assess them, too.
The solutions were selected since they are both popular as well as specific interest in them by the company accompanying this thesis, HvS Consulting.
...
'Required access level' is incrementally increased when less privileges are needed, as this increases the factors contribution to the total risk.
