...
With this chapter, the \gls{owasp} Risk Rating Methodology\footcite{riskRating} will be continued. As completing the risk management process would exceed the scope of this thesis, the full process will be described and the risk management steps will be demonstrated through two exemplary vectors.
...
TODO explain what to do if doing everything, will only implement two examples (list all measures and post-measure risks in annex anyway)
