...
Picking up the three scenarios of section \ref{scopeLimit}, we identify the possible attack vectors in this chapter to get an overview of the attack surface that is posed by \gls{k8s} systems. Vectors and the possible attacks by different threat actors are explained and possible security measures are introduced.
...
\subsection{Research basis and its limits}
%TODO list sources, explain that only best effort and stuff is still building
