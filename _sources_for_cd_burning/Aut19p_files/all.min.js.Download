...
"use strict";function selectTabsets(a,b){document.querySelectorAll(".tabset").forEach(c=>{c.querySelectorAll(".tab-strip").forEach(c=>{const d=c;d.dataset.cookieName===a&&d.querySelectorAll("[role=tab]").forEach(a=>{const c=a.getAttribute(ariaControls);if(c){const d=getById(c);d&&(a.dataset.cookieValue===b?(a.setAttribute(ariaSelected,"true"),a.removeAttribute(tabIndex),d.removeAttribute("hidden")):(a.removeAttribute(ariaSelected),a.setAttribute(tabIndex,"-1"),d.setAttribute("hidden","")))}})})})}function handleTabs(){document.querySelectorAll(".tabset").forEach(a=>{function b(a){c(),a.removeAttribute(tabIndex),a.setAttribute(ariaSelected,"true");const b=a.getAttribute(ariaControls);if(b){const a=getById(b);a&&a.removeAttribute("hidden")}}function c(){g.forEach(a=>{a.setAttribute(tabIndex,"-1"),a.setAttribute(ariaSelected,"false")}),f.forEach(a=>{a.setAttribute("hidden","")})}const d=a.querySelector(".tab-strip");if(!d)return;const e=d.dataset.cookieName,f=a.querySelectorAll("[role=tabpanel]"),g=[];d.querySelectorAll("[role=tab]").forEach(a=>{g.push(a)});const h=new KbdNav(g);if(e){const a=readCookie(e);a&&selectTabsets(e,a)}d.querySelectorAll(button).forEach(a=>{listen(a,"focus",()=>{if(b(a),e){const b=a.dataset.cookieValue;b&&(createCookie(e,b),selectTabsets(e,b))}}),listen(a,"click",()=>{if(b(a),e){const b=a.dataset.cookieValue;b&&(createCookie(e,b),selectTabsets(e,b))}}),listen(a,keydown,a=>{const b=a,c=b.key;if(b.ctrlKey||b.altKey||b.metaKey);else if(b.shiftKey)isPrintableCharacter(c)&&h.focusElementByChar(c);else{switch(b.keyCode){case keyCodes.LEFT:h.focusPrevElement();break;case keyCodes.RIGHT:h.focusNextElement();break;case keyCodes.HOME:h.focusFirstElement();break;case keyCodes.END:h.focusLastElement();break;case keyCodes.TAB:return;default:isPrintableCharacter(c)&&h.focusElementByChar(c);}b.preventDefault(),b.cancelBubble=!0}})})})}handleTabs();
